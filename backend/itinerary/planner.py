            ...
            "messages": [
                model_with_tools.invoke([
                    SystemMessage(content=(
                        ...
                        "- For trains, be geographically accurate. Only include train options if they are realistically available for the route. For international travel or long-distance routes (especially between different countries or continents), trains are typically NOT available. In such cases, return an empty array for trains.\n"
                        ...
                        "- For buses, be geographically accurate. Only include bus options if they are realistically available for the route. For international travel or long-distance routes (especially between different countries or continents), buses are typically NOT available. In such cases, return an empty array for buses.\n"
