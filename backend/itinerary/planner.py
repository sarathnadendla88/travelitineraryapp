            ...
            "messages": [
                model_with_tools.invoke([
                    SystemMessage(content=(
                        ...
                        "}\n\n"
                        "Requirements:\n"
                        "- Use ONLY the travel_serper_search tool for flight information to ensure the most accurate and up-to-date flight prices, schedules, and availability.\n"
                        "- When searching for flight information, use ONLY the travel_serper_search tool with very specific queries like 'flights from [origin] to [destination] on [date] with prices' to get accurate results. Include the airline, flight number, departure/arrival times, and price in your search query.\n"
                        "- When searching for hotel information, use specific queries like 'hotels in [destination] with prices' to get accurate results.\n"
                        "- Use the multi_search tool for other important information (NOT flights) that requires verification from multiple sources.\n"
                        ...
                        "- For trains, be geographically accurate. ALWAYS include train options for routes within the same country or region (e.g., Delhi to Mumbai, Paris to Lyon, New York to Washington DC). For domestic routes, you MUST provide at least 5 train options with realistic details. Only exclude train options for international travel or very long-distance routes between different countries.\n"
                        ...
                        "- For buses, be geographically accurate. ALWAYS include bus options for routes within the same country or region (e.g., Delhi to Mumbai, Paris to Lyon, New York to Washington DC). For domestic routes, you MUST provide at least 5 bus options with realistic details. Only exclude bus options for international travel or very long-distance routes between different countries.\n"
                        ...
                        "- For bus stops, include the location name, arrival time, departure time, and duration of the stop.\n"                        "- IMPORTANT: For routes between cities in different countries (especially distant ones like 'Hyderabad to Paris' or 'New York to Tokyo'), do NOT include train or bus options as these are not realistic transportation methods for such long distances.\n"
